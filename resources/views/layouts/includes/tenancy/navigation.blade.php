            ...
            <div class="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
                ...
                <div class="hidden sm:ml-6 sm:block">
                    <div class="flex space-x-4">
                        ...
                        <div class="rounded-md px-3 py-2" x-data="{ open: false }">
                            <button type="button"
                                class="flex items-center gap-x-1 text-sm font-semibold leading-6 text-white"
                                aria-expanded="false" x-on:click="open = true">
                                Cruds
                                <svg class="h-5 w-5 flex-none text-white-400" viewBox="0 0 20 20" fill="currentColor"
                                    aria-hidden="true">
                                ...
                                <div class="p-4">
                                    <div
                                        ...
                                        <div class="flex-auto">
                                            ...
                                            <p class="mt-1 text-gray-600">Agregar un nuevo tipo de documento</p>
                                        </div>
                                    </div>
                                    <div
                                        class="group relative flex items-center gap-x-6 rounded-lg p-4 text-sm leading-6 hover:bg-gray-50">
                                    ...
                                    <div
                                        ...
                                        <div class="flex-auto">
                                            ...
                                            <p class="mt-1 text-gray-600">Your customers’ data will be safe and secure
                                            </p>
                                        </div>
                                    </div>
                                    <div
                ...
                <div class="relative ml-3" x-data="{ open: false }">
                    <div>
                        <button x-on:click="open = true" type="button"
                            ...
                            @else
                                <div
                                    class="flex items-center justify-center h-10 w-10 rounded-full bg-gray-500 text-white">
                                    {{ auth()->user()->initials }}
                                </div>
                            @endif
                        </button>
                    ...
                    <div x-show="open" x-on:click.away="open = false"
                        ...
                        <a href="{{ route('tenant.profile.edit') }}" class="block px-4 py-2 text-sm text-gray-700"
